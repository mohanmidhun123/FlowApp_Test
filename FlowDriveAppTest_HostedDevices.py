...
'''Automated Testing to verify "TheFlow App functionality on Android devices
...
class TheFlowDriveApp(unittest.TestCase):
    ...
    def test_1(self):
        try:
            ...
            # Verification
            self.assertEqual('User name/password not found. Are you registered?',
    ...
    def test_2(self):
        try:
            ...
            # Verification
            self.assertEqual('Invalid e-mail address',
    ...
    def test_4(self):
        try:
            ...
            # Verification
            self.assertEqual('Welcome to FlowDrive',
                             self.driver.find_elements_by_class_name(self.textFieldsList)[0].text)
        except Exception as e:
            raise e
    ...
    def test_5(self):
        try:
            ...
            self.delay()
            self.assertEqual('What do I need to do next?',
                             self.driver.find_elements_by_class_name(self.textFieldsList)[0].text)
            self.driver.swipe(700, 500, 5, 500, 200)
            self.delay()
            self.assertEqual('Need help with anything else?',
                             self.driver.find_elements_by_class_name(self.textFieldsList)[0].text)
            ...
            self.delay()
            self.assertEqual('Do not interact with the device while driving.',
                             self.driver.find_elements_by_class_name(self.textFieldsList)[2].text)
    ...
    def test_9(self):
        try:
            ...
            # Verification
            self.assertEqual("Code Sent Successfully",
                             self.driver.find_elements_by_class_name(self.textFieldsList)[0].text)
    ...
    def test_12(self):
        try:
            ...
            self.delay()
            self.driver.find_element_by_id(self.LOGIN_PAGE.get("layout-code")).click()
            self.driver.find_element_by_id(self.LOGIN_PAGE.get("text-code")).send_keys(
    ...
    def test_16(self):
        try:
            ...
            self.driver.find_element_by_id(self.LOGIN_PAGE.get("layout-code")).click()
            self.driver.find_element_by_id(self.LOGIN_PAGE.get("text-code")).send_keys(
                "9268")  # put the correct code here. Code is valid for 24 hrs
            self.delay()
            self.BACK()
            self.driver.find_element_by_id(self.LOGIN_PAGE.get("email")).send_keys(self.USER)
            self.delay()
    ...
    def test_18(self):
        try:
            ...
            # Verification
            self.assertEqual("You must be over 17 years of age.",
                             self.driver.find_elements_by_class_name(self.textFieldsList)[1].text)
        except Exception as e:
            raise e
    ...
    def test_20(self):
        try:
            ...
            self.delay()
            # Verification
            self.assertEqual("Password: 8 characters needed.",
                             self.driver.find_elements_by_class_name(self.textFieldsList)[1].text)
        except Exception as e:
            raise e
    ...
    def test_26(self):
        try:
            ...
            self.BACK()
            self.driver.find_elements_by_class_name(self.textFieldsList)[3].click()
            self.assertEqual('Software License Acknowledgements',
                             self.driver.find_element_by_id(self.HELP.get("view-licenses")).text)
            self.BACK()
            self.driver.find_elements_by_class_name(self.textFieldsList)[4].click()
            self.assertEqual('Enter your message...',
                             self.driver.find_element_by_id(self.HELP.get("text-message")).text)
            self.BACK()
    ...
    def test_27(self):
        try:
            ...
            if int((self.driver.find_element_by_id("com.thefloow.flo:id/chrono_duration").text).split(":")[1]) > 00:
                ...
                self.delay()
                self.assertEqual(
                    "This journey will not be recorded because it did not meet the minimum distance of 0.5 mile and the minimum speed of 5 mph.",
                    self.driver.find_elements_by_class_name(self.textFieldsList)[1].text)
                self.driver.find_element_by_id("android:id/button1").click()
                self.delay()
    ...
    def test_28(self):
        try:
            ...
            self.driver.find_element_by_id(self.HELP.get("text-message")).send_keys(
                "ZXCVBNNMASDFGHJKLL!@#$$%^&&**123455677")
